...
colname_GN <- unlist(read_excel(paste0("C:/Stanley/Tugas IFRS17/Reserving RCH Enhancement/", valuation_date, "/Gross Net/Earned Premium/Workbook/EP 2020-ST/Earned Premium.xlsx"), range = paste0("EP!A1:AD1"), col_names = FALSE))
colname_GN[3:14] <- "Gross"
colname_GN[15:26] <- "Net"
colname_NM <- unlist(read_excel(paste0("C:/Stanley/Tugas IFRS17/Reserving RCH Enhancement/", valuation_date, "/Gross Net/Earned Premium/Workbook/EP 2020-ST/Earned Premium.xlsx"), range = paste0("EP!A2:AD2"), col_names = FALSE))
...
EP_contoh <- read_excel(paste0("C:/Stanley/Tugas IFRS17/Reserving RCH Enhancement/", valuation_date, "/Gross Net/Earned Premium/Workbook/EP 2020-ST/Earned Premium.xlsx"), range = paste0("EP!A2:AD",limit_row))
...
for (c in cohort_start:cohort_end){
  ...
  for (t in 0:1){
    ...
    EP_final_temp <- read_excel(paste0("C:/Stanley/Tugas IFRS17/Reserving RCH Enhancement/", valuation_date, "/Gross Net/Earned Premium/Workbook/EP ", c, st_lt, "/Earned Premium.xlsx"), range = paste0("EP!A2:AD",limit_row))
...
for (c in cohort_start:cohort_end){
  ...
  for (t in 0:1){
    ...
    saveWorkbook(wb, paste0("C:/Stanley/Tugas IFRS17/Reserving RCH Enhancement/", valuation_date, "/Gross Net/Earned Premium/Workbook/EP ", c, st_lt, "/Earned Premium.Manual.xlsx"), overwrite = TRUE)
