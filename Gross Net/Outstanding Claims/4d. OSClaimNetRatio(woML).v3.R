...
OS_prior_function <- function(cohort, term, sheet_name){
  ...
  if(sheet_name == "Marine"){
    ...
    data_comp_M <- read_excel("Workbook/OSClaim-Net.Prior.wo.ML.xlsx", sheet = "Marine")
    ...
    '
    #MENGAMBIL DF Compiled
    data_comp_P <- read_excel("Workbook/OSClaim-Net.Prior.wo.ML.xlsx", sheet = "PA")
    ...
    '
    #MENGAMBIL DF Compiled
    data_comp_V <- read_excel("Workbook/OSClaim-Net.Prior.wo.ML.xlsx", sheet = "Various")
    ...
    #MENGAMBIL DF Compiled
    data_comp <- read_excel("Workbook/OSClaim-Net.Prior.wo.ML.xlsx", sheet = sheet_name)
