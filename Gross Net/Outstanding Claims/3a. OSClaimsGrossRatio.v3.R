...
'    #MENGAMBIL DF per Cohort (Partial)
    path_name <- paste0("Workbook/PC ",cohort,st_or_lt,"/OSClaim-Gross.Raw.xlsx")
    ...
    data_comp_M <- read_excel("Workbook/OSClaim-Gross.Prior.xlsx", sheet = "Marine")
    data_comp <- data_comp_M
    
    #MENGAMBIL DF Total (semua cohort)
    path_tot <- "Workbook/OSClaim-GrossTotal.Raw.FIXED-LBLW.v1.xlsx"
...
'    #MENGAMBIL DF per Cohort (Partial)
    ...
    '
    #MENGAMBIL DF Compiled
    data_comp_P <- read_excel("Workbook/OSClaim-Gross.Prior.xlsx", sheet = "PA")
    ...
    '
    #MENGAMBIL DF Compiled
    data_comp_V <- read_excel("Workbook/OSClaim-Gross.Prior.xlsx", sheet = "Various")
...
'    #MENGAMBIL DF per Cohort (Partial)
    ...
    #MENGAMBIL DF Compiled
    data_comp <- read_excel("Workbook/OSClaim-Gross.Prior.xlsx", sheet = sheet_name)
...
for(k in cohort_start:cohort_end){
  ...
  for(l in 0:1){
    ...
    file_path <- paste0("Workbook/OS ", k, st_or_lt, "/OSClaim-Gross.Ratio.xlsx")
