...
for ( i in cohort_start:cohort_end){ #COHORT
  ...
  for (j in 0:1){ #TERM
    ...
    saveWorkbook(wb, paste0(dir_name,"/PaidClaim-Reins.Raw.xlsx"), overwrite = TRUE)
