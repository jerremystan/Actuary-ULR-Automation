...
PC_function <- function(sheet, tahun, kuarter){   #fungsi term, cohort, sheet, tahun, kuarter
...
saveWorkbook(wb, "Workbook/PaidClaim-Gross.Total.Raw.xlsx", overwrite = TRUE)
