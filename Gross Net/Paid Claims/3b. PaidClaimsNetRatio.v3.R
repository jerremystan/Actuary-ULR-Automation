...
'    #MENGAMBIL DF per Cohort (Partial)
    ...
    data_comp_M <- read_excel("Workbook/PaidClaim-Net.Prior.xlsx", sheet = "Marine")
...
'    #MENGAMBIL DF per Cohort (Partial)
    ...
    '
    #MENGAMBIL DF Compiled
    data_comp_P <- read_excel("Workbook/PaidClaim-Net.Prior.xlsx", sheet = "PA")
    ...
    '
    #MENGAMBIL DF Compiled
    data_comp_V <- read_excel("Workbook/PaidClaim-Net.Prior.xlsx", sheet = "Various")
...
'    #MENGAMBIL DF per Cohort (Partial)
    ...
    #MENGAMBIL DF Compiled
    data_comp <- read_excel("Workbook/PaidClaim-Net.Prior.xlsx", sheet = sheet_name)
