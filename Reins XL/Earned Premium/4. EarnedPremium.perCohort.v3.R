...
EP_function <- function(tahun,quarter,term){
  ...
  new_row <- data.frame(`Year` = tahun,
                        `Quarter` = quarter,
                        `Reins_Auto` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "AUTO" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0 ,sql_data$Reins[sql_data$LineOfBusiness == "AUTO" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_Marine-Ecommerce` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "MARINE-ECOMMERCE" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "MARINE-ECOMMERCE" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term], 0),
                        `Reins_Marine-Others` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "MARINE-OTHERS" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) >0 ,sql_data$Reins[sql_data$LineOfBusiness == "MARINE-OTHERS" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term], 0),
                        `Reins_Marine-Others-XL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "MARINE-OTHERS-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "MARINE-OTHERS-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term], 0),
                        `Reins_Fire` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "FIRE" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0 ,sql_data$Reins[sql_data$LineOfBusiness == "FIRE" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term], 0),
                        `Reins_Engineering` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "ENGINEERING" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "ENGINEERING" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_Liability` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "LIABILITY" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "LIABILITY" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_PA-RETAIL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "PA-RETAIL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "PA-RETAIL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_PA-COMMERCIAL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "PA-COMMERCIAL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "PA-COMMERCIAL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_PA-TRAVEL-RETAIL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "PA-TRAVEL-RETAIL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "PA-TRAVEL-RETAIL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_PA-TRAVEL-COMMERCIAL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "PA-TRAVEL-COMMERCIAL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "PA-TRAVEL-COMMERCIAL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_PA-XL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "PA-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "PA-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_VARIOUS-FIRE` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-FIRE" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-FIRE" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_VARIOUS-LIABILITY` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-LIABILITY" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-LIABILITY" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_VARIOUS-PA-RETAIL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-PA-RETAIL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-PA-RETAIL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_VARIOUS-PA-COMMERCIAL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-PA-COMMERCIAL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-PA-COMMERCIAL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_VARIOUS-TRADE CREDIT` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-TRADE CREDIT" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0, sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-TRADE CREDIT" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_VARIOUS-TRAVEL-RETAIL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-TRAVEL-RETAIL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-TRAVEL-RETAIL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_VARIOUS-TRAVEL-COMMERCIAL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-TRAVEL-COMMERCIAL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-TRAVEL-COMMERCIAL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_VARIOUS-TRAVEL-XL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-TRAVEL-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-TRAVEL-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_VARIOUS-OTHERS` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-OTHERS" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-OTHERS" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        `Reins_VARIOUS-OTHERS-XL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-OTHERS-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-OTHERS-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        ...
                        `Reins_HEALTH` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "HEALTH" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "HEALTH" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        ...
                        `Reins_VARIOUS-ECOMMERCE` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-ECOMMERCE" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-ECOMMERCE" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        ...
                        `Reins_MARINE-ECOMMERCE-XL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "MARINE-ECOMMERCE-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "MARINE-ECOMMERCE-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        ...
                        `Reins_VARIOUS-ECOMMERCE-XL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-ECOMMERCE-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "VARIOUS-ECOMMERCE-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        ...
                        `Reins_AUTO-XL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "AUTO-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "AUTO-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        ...
                        `Reins_ENGINEERING-XL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "ENGINEERING-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "ENGINEERING-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        ...
                        `Reins_FIRE-XL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "FIRE-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "FIRE-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        ...
                        `Reins_TRADE CREDIT-XL` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "TRADE CREDIT-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "TRADE CREDIT-XL" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
                        ...
                        `Reins_LBLW` = ifelse(length(sql_data$Reins[sql_data$LineOfBusiness == "LBLW" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term]) > 0,sql_data$Reins[sql_data$LineOfBusiness == "LBLW" & sql_data$Tahun == tahun & sql_data$Kuarter == quarter & sql_data$Cohort == c & sql_data$IsShortTerm == term],0),
...
write.csv(to_excel, paste0(dir_name,"/Earned Premium.Reins.Raw. ",sheet_name,".csv"), row.names = FALSE)
...
saveWorkbook(wb, paste0(dir_name,"/Earned Premium.Reins.Raw",".xlsx"), overwrite = TRUE)
